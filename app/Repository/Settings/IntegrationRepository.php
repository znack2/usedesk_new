...
class IntegrationRepository extends AbstractRepository
{
    ...
    {
        $customBlock = DB::table('company_integrations')
        //relation
    ...
    {
        $customBlock = DB::table('company_integrations')->insertGetId([
     ...
     * @return $customBlock
     */
    public function enableGetStarted($id,$logotype)
    {
        $customBlock = DB::table('company_integrations')
            ->where(['id' => $id])
            ->update(['get_started' => ]);
     ...
     * @return $customBlock
     */
    public function enableSignature($id,$logotype)
    {
        $customBlock = DB::table('company_integrations')
            ->where(['id' => $id])
            ->update(['signature_enabled' => $logotype]);
        return $customBlock;
    }
    /**
     * @param int $company_id
